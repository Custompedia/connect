// Endpoint penerima submission form audit: POST /api/audit-lead
// Alur: parse -> honeypot -> rate-limit -> Turnstile (opsional) -> validasi
//       -> simpan Notion -> notifikasi tim -> { ok: true }
//
// Data contract (§5):
...
import { saveLeadToNotion } from '../../lib/notion.js';
...
export async function onRequestPost(context) {
  ...
  if (!storedOk && !notifiedOk) {
    console.error('audit-lead: gagal simpan & notifikasi', {
      saved,
      notified,
    });
    return json(
